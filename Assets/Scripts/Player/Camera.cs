    ...
    public class Camera : MonoBehaviour
    {
        ...
        void Update()
        {
            if (player == null)
            {
                ...
                if (obj == null) return;
                obj.GetComponent<Controller>().UpdateHandler += UpdateCamera;
        ...
        /// [入力] カメラの回転
        /// </summary>
        void OnCamera(InputAction.CallbackContext contex)
        {
            rotateVec = contex.ReadValue<Vector2>();
        }

        /// <summary>
        /// [入力] カメラの距離
        /// </summary>
        void OnScroll(InputAction.CallbackContext contex)
        {
            scroll = contex.ReadValue<float>() * speedInput;
        }
    }
